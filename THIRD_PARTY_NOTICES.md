...
- Project page: https://modrinth.com/mod/vintagefix
- License: LGPL-3.0-or-later
- Notes: Optimization mod for Minecraft 1.12.2. The project page recommends not using OptiFine with it.

## MixinBooter

- Project page: https://modrinth.com/mod/mixinbooter
- License: LGPL-2.1-only
- Notes: Required dependency for VintageFix.

## Gammabright

- Project page: https://www.curseforge.com/minecraft/mc-mods/gammabright
- CurseForge project ID: `222539`
- Notes: The 1.12.2 file is a LiteLoader mod according to the project page.

## Bloodmoon

- Project page: https://www.curseforge.com/minecraft/mc-mods/bloodmoon
...
- GVCLib: https://www.curseforge.com/minecraft/mc-mods/gvclib
